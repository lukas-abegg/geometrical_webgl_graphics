    ...
    function createVertexData() {
        ...
        for (var i = 0, u = 0; i <= n; i++, u += du) {
            ...
            for (var j = 0, v = 0; j <= m; j++, v += dv) {
                ...
                // color
                if (v <= 0.2) {
                    colors[iVertex * 4] = 1 - v * 5;
                    colors[iVertex * 4 + 1] = 1 / v * 5;
                    colors[iVertex * 4 + 2] = 1 - v * 5;
                    colors[iVertex * 4 + 3] = 1;
                }
                if (v > 0.2 && v <= 0.4) {
                    colors[iVertex * 4] = v * 2.5;
                    colors[iVertex * 4 + 1] = 1 - v * 2.5;
                    colors[iVertex * 4 + 2] = 1 / v * 2.5;
                    colors[iVertex * 4 + 3] = 1;
                }
                if (v > 0.4 && v <= 0.6) {
                    colors[iVertex * 4] = 1 / v * (1.0 / 0.6);
                    colors[iVertex * 4 + 1] = v * (1.0 / 0.6);
                    colors[iVertex * 4 + 2] = 1 - v * (1.0 / 0.6);
                    colors[iVertex * 4 + 3] = 1;
                }

                if (v > 0.6 && v <= 0.8) {
                    colors[iVertex * 4] = 1 - v * (1.0 / 0.8);
                    colors[iVertex * 4 + 1] =  1 / v * (1.0 / 0.8);
                    colors[iVertex * 4 + 2] = v * (1.0 / 0.8);
                    colors[iVertex * 4 + 3] = 1;
                }
                if (v > 0.8 && v <= 1) {
                    colors[iVertex * 4] = v;
                    colors[iVertex * 4 + 1] = 1 - v;
                    colors[iVertex * 4 + 2] = 1 / v / 2;
                    colors[iVertex * 4 + 3] = 1;
                }
